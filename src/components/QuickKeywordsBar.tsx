...
const KEYWORDS = [
  ...
  "Jaipur sakshi escort call girl",
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <div>
          ...
          <p className="text-xs sm:text-sm text-center text-slate-400 mb-8 max-w-2xl mx-auto">
            Click any colorful tag below to open instant WhatsApp chat with
            pre-filled service inquiry.
          </p>
          ...
          <div className="flex flex-wrap items-center justify-center gap-2.5 sm:gap-3">
            {KEYWORDS.map((kw, idx) => {
              ...
              const waText = encodeURIComponent(
                `Hello, I am looking for ${kw}. Please provide details and host availability.`,
              );
